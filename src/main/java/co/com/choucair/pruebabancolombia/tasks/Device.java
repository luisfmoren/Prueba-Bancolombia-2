...
public class Device implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(DevicePage.INPUT_COMPUTER),
                Click.on(DevicePage.SELECT_DROPDOWN_COMPUTER),
                Click.on(DevicePage.INPUT_VERSION),
                Click.on(DevicePage.SELECT_DROPDOWN_VERSION),
                Click.on(DevicePage.INPUT_LANGUAGE),
                Click.on(DevicePage.SELECT_DROPDOWN_LANGUAGE),
                Click.on(DevicePage.INPUT_DEVICE),
                Click.on(DevicePage.SELECT_DROPDOWN_DEVICE),
                Click.on(DevicePage.INPUT_MODEL),
                Click.on(DevicePage.SELECT_DROPDOWN_MODEL),
                Click.on(DevicePage.INPUT_SYSTEM),
                Click.on(DevicePage.SELECT_DROPDOWN_SYSTEM),
