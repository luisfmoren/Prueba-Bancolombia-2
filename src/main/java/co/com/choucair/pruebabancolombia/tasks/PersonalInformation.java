...
public class PersonalInformation implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(PersonalInformationPage.BUTTON_SIGNIN),
                ...
                SelectFromOptions.byVisibleText(month).from(PersonalInformationPage.INPUT_MONTH),
                SelectFromOptions.byVisibleText(day).from(PersonalInformationPage.INPUT_DAY),
                SelectFromOptions.byVisibleText(year).from(PersonalInformationPage.INPUT_YEAR),
